...
public class MachineProject extends Project {

    private static final Logger log = LoggerFactory.getLogger(MachineProject.class);
    private static final String INSERT_DATA = "select MachineTaskInsert(?, ?, ?, ?, ?, ?, ?)";
    private static final String GET_TIME = "select MachineGetLastTaskDate()";
    private static final String JQL = Config.getInstance().getValue("jira.jqlMachine");
