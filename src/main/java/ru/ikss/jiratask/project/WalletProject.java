...
public class WalletProject extends Project {

    private static final Logger log = LoggerFactory.getLogger(WalletProject.class);
    private static final String INSERT_DATA = "select WalletTaskInsert(?, ?, ?, ?, ?, ?, ?)";
    private static final String GET_TIME = "select WalletGetLastTaskDate()";
    private static final String JQL = Config.getInstance().getValue("jira.jqlWallet");
