...
public class UXProject extends Project {

    private static final Logger log = LoggerFactory.getLogger(UXProject.class);
    private static final String INSERT_DATA = "select UXTaskInsert(?, ?, ?, ?, ?, ?, ?)";
    private static final String GET_TIME = "select UXGetLastTaskDate()";
    private static final String JQL = Config.getInstance().getValue("jira.jqlUX");
