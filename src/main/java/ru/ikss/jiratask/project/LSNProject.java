...
public class LSNProject extends Project {

    private static final Logger log = LoggerFactory.getLogger(LSNProject.class);
    private static final String INSERT_DATA = "select LSNTaskInsert(?, ?, ?, ?, ?, ?, ?)";
    private static final String GET_TIME = "select LSNGetLastTaskDate()";
    private static final String JQL = Config.getInstance().getValue("jira.jqlLSN");
