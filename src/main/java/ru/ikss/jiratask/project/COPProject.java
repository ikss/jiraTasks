...
public class COPProject extends Project {

    private static final Logger log = LoggerFactory.getLogger(COPProject.class);
    private static final String INSERT_DATA = "select COPTaskInsert(?, ?, ?, ?, ?, ?, ?)";
    private static final String GET_TIME = "select COPGetLastTaskDate()";
    private static final String JQL = Config.getInstance().getValue("jira.jqlCOP");
